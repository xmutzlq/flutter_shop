class Api {
  ...
  static const String BASE_URL = 'https://xljapi.s.cn';
  static const String HOME_URL=BASE_URL+'/home/index';//首页数据
  static const String BANNER_URL = BASE_URL + '/app/Shops/getShopData'; //获取首页banner图
  static const String CATEGORY_URL = BASE_URL + '/app/GoodsCats/getTopCat'; //获取首页分类
  static const String CATEGORY_GOODS_LIST_URL = BASE_URL + '/app/GoodsCats/getChildCat';//分类下的商品列表
  static const String GOODS_DETAILS_URL = BASE_URL + '/app/Goods/goodsDetail';//商品详情
  static const String GOODS_LIST_URL = BASE_URL + '/app/Lists/goodsList';//商品列表
